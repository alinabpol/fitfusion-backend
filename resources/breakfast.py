...
def create_recipe():
    ...
    print(payload)
    new_recipe = models.Breakfast.create(title=payload['title'], img=payload['img'], time=payload["time"], ingredients=payload["ingredients"], description=payload['description'])
